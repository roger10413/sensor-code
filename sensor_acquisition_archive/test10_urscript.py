...
# --- 感測器接觸點 (你提供的實測值) ---
CONTACT_POSE  = [0.42395, 0.05195, 0.25148, -2.17478, 2.26082, -0.00508]#0.42218, 0.05222, 0.24168, 2.17606, -2.26215, -0.00965
...
# --- 壓測 (固定力) ---
FIXED_FORCE   = 20.0           # ★★★ 固定施力值 N (每次都壓一樣)
N_CYCLES      = 5              # ★★★ 施力→空載 重複幾次
HOLD_TIME     = 60.0          # 加載保持秒數
UNLOAD_TIME   = 5.0         # 空載保持秒數
